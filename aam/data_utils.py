...
def get_table_data(table, max_bp, nuc_encoding):
...
def load_data(
    ...
    if tree_path:
        ...
        o_ids, table_dataset, sequence_tokenizer = get_table_data(table, max_bp, nuc_encoding)
    ...
    if metadata_path:
        ...
        o_ids, table_dataset, sequence_tokenizer = get_table_data(table.copy(), max_bp, nuc_encoding)
